...
class strength extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(actions: [
      ...
      title: Center(child: Text("STRENGTH TRANING",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)),
 ...
 Container(child:Column(children: [
          ...
          child: Center(child: Text("CONCENTRATION CURL", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),),
     SizedBox(height: 30,),
