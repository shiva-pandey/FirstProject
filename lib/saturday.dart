...
import 'package:gym/leg.dart';
 // import 'package:nivesh/leg.dart';
  ...
  child:   ListView(
    children: [ 
     ...
     // leading: Icon(Icons.account_balance_wallet_sharp,color: Color.fromARGB(255, 22, 216, 4),size: 30,),
      ...
      body: 
           Container(decoration: BoxDecoration(gradient: SweepGradient(colors: [Colors.black,Colors.white,Colors.black])),
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  
                  child: Center(child: Text("SARURDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
              //   SizedBox(height: 20,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return leg();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.8,child: Image.asset('assets/images/w3.jpg',width: 480,height: 550,fit: BoxFit.fill,)),
                                 Opacity(opacity: 1 ,child: Text("leg",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 156, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
              ...
              /*    SizedBox(height: 60,),
                 Card(
                  elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                   child: Column(
                    children: [
                       Opacity( opacity: 0.7,child: Image.asset('assets/images/lw.jpg',)),
                               Opacity(opacity: 1 ,child: Text("CALF",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                               shadows: [
                                Shadow(
                   color: Colors.black,
                   offset: Offset(8,8),
