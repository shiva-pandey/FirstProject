  ...
  Widget build(BuildContext context) {
   ...
   body: DefaultTabController(length: 4,child: Scaffold(
    appBar: AppBar(actions: [
      ...
      title: Center(child: Text("LEG WORKOUT",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)),
      ...
      body: Column(children: [
        ...
        Container(child:Column(children: [
         ...
         child: Center(child: Text("DUMBBELL LUNGES", style: TextStyle(fontSize: 50,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),),
     SizedBox(height: 30,),
      Image.asset("assets/images/leg2.gif"),
        Column(
            children: [
...
Container(child:Column(children: [
          ...
          child: Column(
            children: [
              Center(child: Text("LEG CURL", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
     ...
     SizedBox(height: 30,),
      Image.asset("assets/images/leg4.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
 ...
 Container(child:Column(children: [
          ...
          child: Column(
            children: [
              Center(child: Text("  LEG", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
               Center(child: Text("EXTENTIONS", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
            ],
          ),),
     SizedBox(height: 10,),
      Image.asset("assets/images/leg5.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
