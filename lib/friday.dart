...
import 'package:gym/strength.dart';
             ...
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  ...
                  child: Center(child: Text("FRIDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
                
                 

                  SizedBox(height: 40,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return strength();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/bw2.jpg',width: 500,height: 500,fit: BoxFit.fill,)),
                                 Opacity(opacity: 1 ,child: Text("STRENGTH",style: TextStyle(fontSize: 50,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
                     blurRadius: 8,
                                      ...
                                      Opacity(opacity: 1 ,child: Text("TRANING...",style: TextStyle(fontSize: 50,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
