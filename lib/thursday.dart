...
import 'package:gym/abs.dart';
import 'package:gym/weight.dart';
             ...
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  ...
                  child: Center(child: Text("THURSDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
                
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return abs();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/a.jpg',)),
                                 Opacity(opacity: 1 ,child: Text("ABS",style: TextStyle(fontSize: 50,color: Color.fromARGB(126, 156, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
                  ...
                  SizedBox(height: 40,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return weight();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/legw.jpg',)),
                                 Column(
                                   children: [
                                     Opacity(opacity: 1 ,child: Text("WEIGHT",style: TextStyle(fontSize: 50,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                     shadows: [
                                      Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
                     blurRadius: 8,
                       ...
                       Opacity(opacity: 1 ,child: Text("LIFTING",style: TextStyle(fontSize: 50,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
