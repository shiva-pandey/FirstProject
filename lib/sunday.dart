             ...
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  ...
                  child: Center(child: Text("SUNDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
                 SizedBox(height: 20,),
                 Card(
                  elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                   child: Column(
                    children: [
                       Opacity( opacity: 1,child: Image.asset('assets/images/rest.jpg')),
                               Opacity(opacity: 1 ,child: Text("REST",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 156, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                               shadows: [
                                Shadow(
                   color: Colors.black,
                   offset: Offset(8,8),
                 ...
                 Card(
                  elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                   child: Column(
                    children: [
                      // Opacity( opacity: 0.7,child: Image.asset('assets/images/t.jpg',width: 300,)),
                               Opacity(opacity: 1 ,child: Text("TIME TO",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                               shadows: [
                                Shadow(
                   color: Colors.black,
                   offset: Offset(8,8),
                   blurRadius: 8,
                               ...
                               Opacity(opacity: 1 ,child: Text("HEAL...",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                               shadows: [
                                Shadow(
                   color: Colors.black,
                   offset: Offset(8,8),
