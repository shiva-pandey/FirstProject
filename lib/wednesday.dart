...
import 'package:gym/fourarms.dart';
import 'package:gym/sholder.dart';
             ...
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  ...
                  child: Center(child: Text("WEDNESDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
                 SizedBox(height: 20,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return sholder();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/s.jpg',)),
                                 Opacity(opacity: 1 ,child: Text("SHOLDER",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 156, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
                  ...
                  SizedBox(height: 60,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return fourarms();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 1,child: Image.asset('assets/images/f.jpg',)),
                                 Opacity(opacity: 1 ,child: Text("FOURARM",style: TextStyle(fontSize: 55,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
