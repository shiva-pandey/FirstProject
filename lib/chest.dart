...
class chest extends StatelessWidget {
 ...
 Container(child:Column(children: [
          ...
          child: Center(child: Text("BENCH PRESS", style: TextStyle(fontSize: 50,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),),
     SizedBox(height: 30,),
      Image.asset("assets/images/chest2.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
...
Container(child:Column(children: [
          ...
          child: Column(
            children: [
              Center(child: Text(" ONE HAND CABLE", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
     ...
     SizedBox(height: 30,),
      Image.asset("assets/images/chest7.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
