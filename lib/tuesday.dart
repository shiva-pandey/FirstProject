             ...
             child: Column(
               children: [
                Container(width: double.infinity,color: Colors.black,
                  ...
                  child: Center(child: Text("TUESDAY",style: TextStyle(fontSize: 50,fontWeight: FontWeight.w900,color: Color.fromARGB(255, 199, 4, 4)),))),
                 SizedBox(height: 20,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return back();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/bw.jpg',width: 300,)),
                                 Opacity(opacity: 1 ,child: Text("BACK",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 156, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
                  ...
                  SizedBox(height: 60,),
                 InkWell(onTap:  (){
                      Navigator.push(context, MaterialPageRoute(builder: (context){return bisep();}));
                    },
                   child: Card(
                    elevation: 40,shadowColor: Colors.red,color: Colors.transparent,
                     child: Column(
                      children: [
                         Opacity( opacity: 0.7,child: Image.asset('assets/images/b.jpg',width: 300,)),
                                 Opacity(opacity: 1 ,child: Text("BISEP",style: TextStyle(fontSize: 60,color: Color.fromARGB(126, 158, 2, 2).withOpacity(.8),fontWeight: FontWeight.bold,
                                 shadows: [
                                  Shadow(
                     color: Colors.black,
                     offset: Offset(8,8),
