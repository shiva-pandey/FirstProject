...
class back extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    appBar: AppBar(actions: [
      ...
      title: Center(child: Text("BACK WORKOUT",style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),)),
      ...
      body: Column(children: [
        ...
        Container(child:Column(children: [
         ...
         child: Center(child: Text("BEND OVER ROW", style: TextStyle(fontSize: 50,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),),
     SizedBox(height: 30,),
      Image.asset("assets/images/back1.gif"),
        Column(
            children: [
...
Container(child:Column(children: [
          ...
          child: Column(
            children: [
              Center(child: Text("DUMBBLLE BEND", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
               Center(child: Text("OVER ROW", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
            ],
          ),),
     SizedBox(height: 30,),
      Image.asset("assets/images/back3.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
 ...
 Container(child:Column(children: [
          ...
          child: Column(
            children: [
              Center(child: Text("T-BAR BEND", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
               Center(child: Text("OVER ROW", style: TextStyle(fontSize: 40,color: Color.fromARGB(255, 63, 1, 1).withOpacity(1),fontWeight: FontWeight.bold),)),
            ],
          ),),
     SizedBox(height: 10,),
      Image.asset("assets/images/back4.gif"),
        Column(
            children: [
              Card(color: Colors.blue.withOpacity(0.2),
          shadowColor: Color.fromARGB(255, 250, 246, 1),
